...
public class WorldRenderManager implements GLSurfaceView.Renderer {
    ...
    private TextView mPlaneOtherTextView;

    private TextView mPlaneWallTextView;

    private TextView mPlaneFloorTextView;

    private TextView mPlaneSeatTextView;

    private TextView mPlaneTableTextView;

    private TextView mPlaneCeilingTextView;
    ...
    private ArrayList<Bitmap> getPlaneBitmaps() {
        ...
        bitmaps.add(getPlaneBitmap(mPlaneOtherTextView));
        bitmaps.add(getPlaneBitmap(mPlaneWallTextView));
        bitmaps.add(getPlaneBitmap(mPlaneFloorTextView));
        bitmaps.add(getPlaneBitmap(mPlaneSeatTextView));
        bitmaps.add(getPlaneBitmap(mPlaneTableTextView));
        bitmaps.add(getPlaneBitmap(mPlaneCeilingTextView));
        return bitmaps;
    }

    private Bitmap getPlaneBitmap(TextView textView) {
    ...
    public void setTextViews(@Nullable TextView textView, @Nullable TextView searchingTextView, @Nullable TextView planeOtherTextView, @Nullable TextView planeWallTextView, @Nullable TextView planeFloorTextView, @Nullable TextView planeSeatTextView, @Nullable TextView planeTableTextView, @Nullable TextView planeCeilingTextView) {
        mTextView = textView;
        mSearchingTextView = searchingTextView;
        mPlaneOtherTextView = planeOtherTextView;
        mPlaneWallTextView = planeWallTextView;
        mPlaneFloorTextView = planeFloorTextView;
        mPlaneSeatTextView = planeSeatTextView;
        mPlaneTableTextView = planeTableTextView;
        mPlaneCeilingTextView = planeCeilingTextView;
        ;
    }
}